...
Each chapter of the book has as a separate Markdown file in the `chapters/`
directory (e.g., `chapters/intro.md` for the introduction). If you want to fix
typos or add material, edit these chapters directly. Please do not make edits to
the `README.md` file as this file will be automatically generated by running the
`.scripts/build.py` script. Auxiliary scripts such as the book build and the
post-processing step for the deployed site all live in `.scripts/`.
...
6. After any changes, rerun `python3 .scripts/build.py` from the root directory
   to see the changes reflected in your browser.

## Submitting a Pull Request

1. Fork the repository to your GitHub account.

2. Make your changes directly to the relevant Markdown files in the `chapters/`
