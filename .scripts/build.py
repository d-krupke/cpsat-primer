"""
This file is used to build the `README.md` file from all markdown files in `chapters/`.
It also converts the markdown files to a format that can be used by the `mdbook` tool, which we
use to generate the website.

Run it as `python3 .scripts/build.py`. Paths are resolved relative to the repository
root (the parent of this script's directory), so the working directory does not matter.
"""
...
*If you find the primer helpful, consider leaving a ⭐ on [GitHub (750⭐)](https://github.com/d-krupke/cpsat-primer) or [sharing your feedback/experience](https://www.linkedin.com/in/dominik-krupke-9869b2241/). Your support helps improve and sustain this free resource.*
    """
    content = (
        "<!-- This file was generated by the `.scripts/build.py` script. Do not edit it manually. -->\n"
        + content
    )
...
class Document:
    ...
    def write_readme(self, path: str):
        ...
        with open(path, "w") as f:
            ...
            disclaimer = "<!-- This file was generated by the `.scripts/build.py` script. Do not edit it manually. -->\n"
...
if __name__ == "__main__":
    ...
    document = Document(
        [
            MarkdownFile("./chapters/intro.md", "intro.md"),
            MarkdownFile("./chapters/installation.md", "installation.md"),
            MarkdownFile("./chapters/example.md", "example.md"),
            MarkdownFile("./chapters/modelling.md", "modelling.md"),
            MarkdownFile("./chapters/advanced_modelling.md", "advanced_modelling.md"),
            MarkdownFile("./chapters/parameters.md", "parameters.md"),
            MarkdownFile(
            ...
            MarkdownFile("chapters/machine_learning.md", "machine_learning.md"),
    ...
    document.write_readme(str(REPO_ROOT / "README.md"))
    # write the mdbook files to the .mdbook directory
    document.write_mdbook(str(REPO_ROOT / ".mdbook"))
